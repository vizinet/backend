...
class UserCreationForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if 'confirm_email' in self.cleaned_data and self.cleaned_data[
        ...
        if 'password' in self.cleaned_data and 'confirm_password' in self.cleaned_data and self.cleaned_data[
    ...
    def cleanUsername(self):
        if not usernameValidator(self.cleaned_data.get('username')):
            self.add_error(
                'username',
                'Username contains invalid characters. Usernames may only consist of letters')
