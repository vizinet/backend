...
from file_upload.TwoTargetContrast import TwoTargetContrast
...
class Picture(models.Model):
    ...
    # user object representing who uploaded this image
...
class AlgorithmOne(models.Model):
    ...
    def findTwoTargetContrastVr(self):
        ...
        vrR = TwoTargetContrast(
            farRed,
            nearRed,
            self.farDistance,
            self.nearDistance)
        vrG = TwoTargetContrast(
            farGreen,
            nearGreen,
            self.farDistance,
            self.nearDistance)
        vrB = TwoTargetContrast(
            farBlue,
            nearBlue,
            self.farDistance,
            self.nearDistance)
